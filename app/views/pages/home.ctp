<div class="page">
	...
	<br><br>
	<h1>Search</h1>
	RCPedia is based on search mechanisms. Retrocopies events can be searched on the top search box by coordinates, such as chr1 or chr1:78275455-79988153, which returns all retrocopies located whithin the searched area. Besides, it's yet possible to search retrocopies using their name, parental official gene name and full name.
	</tex>
</div>
<div class="news">
